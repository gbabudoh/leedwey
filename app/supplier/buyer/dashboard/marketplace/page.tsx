...
export default function SupplierMarketplace() {
  ...
  const categories = ["All", "Raw Metals", "Polymers", "Electronic Components", "Industrial Fluids"];

  const products = [
    {
      id: "MAT-9920",
      name: "Aluminum Alloy 6061 Lot",
      lotSize: "50 Tons",
      price: "$1,800.00 / ton",
      factory: "AluForm Global Hub",
      status: "Inbound JIT",
      image: "Alloy lot",
      specs: ["Grade 6061", "Heat Treated"]
    },
    {
      id: "MAT-8812",
      ...
      lotSize: "20 Tons",
      price: "$1,100.00 / ton",
      factory: "PolyCore Systems",
      status: "Direct Sourced",
      image: "Polymer lot",
      specs: ["Industrial Grade", "Recyclable"]
    },
  ];
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-3">
           ...
           <p className="text-slate-500 font-bold max-w-xl text-lg leading-snug">
             Procure the raw components required for your factory-mesh production nodes.
           </p>
        </div>
