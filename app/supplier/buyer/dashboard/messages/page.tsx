...
export default function SupplierMessagesPage() {
  ...
  const [selectedChat, setSelectedChat] = useState("MiningNode");
  ...
  const chats = [
    { id: "MiningNode", name: "Mining Hub X-9", lastMsg: "Ore manifest for ST-1102 is verified.", time: "4m", unread: 3, avatar: "M", status: "online" },
    { id: "Logistics", name: "JIT Logistics", lastMsg: "Material stream initiated for Node-Y.", time: "1h", unread: 0, avatar: "L", status: "online" },
  ];

  const mails = [
    {
      id: "1",
      sender: "Global Material Hub",
      subject: "ST-1102: Material Stream Manifest & JIT Schedule",
      preview: "Following your supply request, we have finalized the material manifest...",
      content: "Dear Supply Partner,\n\nWe have finalized the Material Stream Manifest for Order ST-1102. \n\nTotal Volume: 20 Tons (Aluminum Alloy)\nStream ID: ST-99021-X\nLogistics Node: JIT-FastTrack\n\nPlease find the attached Material Audit Trail and Proforma Invoice for your records. The escrow release is now pending delivery verification at the factory mesh.",
      timestamp: "09:15 AM",
      category: "quote",
      read: false,
      starred: true,
    ...
    <div className="flex h-[calc(100vh-100px)] bg-slate-50 overflow-hidden">
      ...
      <div className="w-[450px] bg-white border-r border-slate-100 flex flex-col">
        <div className="p-10 flex items-center gap-6 border-b border-slate-50">
           ...
           <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">Material Communications</h1>
              <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-0.5 flex items-center gap-2">
                 <Globe className="w-3.5 h-3.5" />
                 Global Supply Node: SN-4420
              </p>
           </div>
        </div>
                  ...
                  <div className="flex items-center gap-5">
                     ...
                     <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                           ...
                           <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Encrypted Supplier Node</p>
                        </div>
                     </div>
                  </div>
