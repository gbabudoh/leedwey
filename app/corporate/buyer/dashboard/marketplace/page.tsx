...
export default function CorporateMarketplace() {
  ...
  const categories = ["All", "Enterprise IT", "Office Infrastructure", "Corporate Fleet", "MRO Supplies"];

  const products = [
    {
      id: "ENT-9920",
      name: "Corporate IT Infrastructure Lot",
      lotSize: "1,000 Units",
      price: "$1,250.00 / unit",
      factory: "SinoPrecision Enterprise",
      status: "ERP Synced",
      image: "IT lot",
      specs: ["Enterprise Grade", "3-Year Warranty"]
    },
    {
      id: "ENT-8812",
      name: "Ergonomic Office Solutions",
      lotSize: "500 Units",
      price: "$350.00 / unit",
      factory: "VisionCore Systems",
      status: "Procurement Active",
      image: "Office lot",
      specs: ["ANSI/BIFMA Rated", "Bulk Shipping"]
    },
  ];
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-3">
           <div className="flex items-center gap-2 text-[10px] font-black text-slate-500 uppercase tracking-[0.3em]">
              ...
              Enterprise Sourcing Terminal
           </div>
           <h1 className="text-5xl font-black text-slate-900 tracking-tighter">
             Enterprise <span className="text-indigo-600">Sourcing</span>
           </h1>
           <p className="text-slate-500 font-bold max-w-xl text-lg leading-snug">
             Consolidated procurement for multi-departmental enterprise requirements.
           </p>
        </div>
