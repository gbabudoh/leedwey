...
export default function GovernmentMessagesPage() {
  ...
  const [selectedChat, setSelectedChat] = useState("AuditNode");
  ...
  const chats = [
    { id: "AuditNode", name: "National Audit Node", lastMsg: "Compliance manifest for GT-1102 is verified.", time: "4m", unread: 3, avatar: "A", status: "online" },
    { id: "Treasury", name: "Public Treasury", lastMsg: "Funds allocated for Q4 regional mesh.", time: "1h", unread: 0, avatar: "T", status: "online" },
  ];

  const mails = [
    {
      id: "1",
      sender: "National Procurement Authority",
      subject: "GT-1102: Public Sourcing Manifest & Transparency Audit",
      preview: "Following the public tender request, we have finalized the sourcing manifest...",
      content: "To the Authorized Representative,\n\nWe have finalized the National Sourcing Manifest for Public Tender GT-1102. \n\nTotal Volume: 1,200 Nodes (Medical Infrastructure)\nAudit ID: GT-99021-G\nTransparency Hash: 0x882...F21\n\nPlease find the attached Blockchain Verification Log and Compliance Audit for your records. The escrow release is subject to public oversight protocols.",
      timestamp: "09:15 AM",
      category: "quote",
      read: false,
      starred: true,
  ...
  return (
    <div className="flex h-[calc(100vh-100px)] bg-slate-50 overflow-hidden">
      ...
      <div className="w-[450px] bg-white border-r border-slate-100 flex flex-col">
        <div className="p-10 flex items-center gap-6 border-b border-slate-50">
           ...
           <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">National Communications</h1>
              <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-0.5 flex items-center gap-2">
                 <Globe className="w-3.5 h-3.5" />
                 National Audit Node: GN-1120
              </p>
           </div>
        </div>
