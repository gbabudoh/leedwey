...
export default function WholesalerWalletPage() {
  const transactions = [
    { id: "TX-99021", type: "ESCROW_RELEASE", amount: "-$375,000", partner: "SinoPrecision Ltd.", date: "Oct 22, 2026", status: "VERIFIED" },
    { id: "TX-98812", type: "ESCROW_DEPOSIT", amount: "+$250,000", partner: "External Bank Node", date: "Oct 20, 2026", status: "SECURED" },
    { id: "TX-97741", type: "PROTECTION_FEE", amount: "-$1,200", partner: "Leedwey Escrow Service", date: "Oct 19, 2026", status: "VERIFIED" },
  ];
    ...
    <div className="p-8 space-y-10 animate-in fade-in duration-1000">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
           <button className="px-8 py-4 bg-slate-900 text-white font-black rounded-2xl hover:bg-emerald-600 transition-all flex items-center gap-3 shadow-2xl shadow-slate-200 active:scale-95 cursor-pointer text-xs uppercase tracking-widest">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
         ...
         <div className="lg:col-span-4 bg-slate-100 p-10 rounded-[3.5rem] text-slate-900 relative overflow-hidden shadow-sm">
            ...
            <div className="space-y-4">
               {["Verified Node: US-EAST", "Escrow ID: WH-9920", "Audit Trail: Immutable"].map((t, i) => (
      ...
      <div className="bg-white rounded-[3.5rem] border border-slate-100 shadow-sm overflow-hidden">
         <div className="p-10 border-b border-slate-50 flex items-center justify-between">
            ...
            <button className="text-xs font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-700 transition-colors cursor-pointer">Download Manifest</button>
         </div>
               ...
               <div key={tx.id} className="p-10 flex items-center justify-between hover:bg-slate-50/50 transition-colors group cursor-pointer">
                  <div className="flex items-center gap-8 cursor-pointer">
                     <div className={cn(
                        ...
                        tx.amount.startsWith("+") ? "bg-emerald-50 text-emerald-600" : "bg-slate-900 text-white"
                     )}>
                        {tx.amount.startsWith("+") ? <ArrowDownLeft className="w-6 h-6" /> : <ShieldCheck className="w-6 h-6 text-emerald-400" />}
                     </div>
