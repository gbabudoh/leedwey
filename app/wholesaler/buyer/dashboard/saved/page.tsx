...
export default function WholesalerSavedPage() {
  const factories = [
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
           ...
           <p className="text-sm text-slate-400 font-bold uppercase tracking-widest mt-1 flex items-center gap-2">
              ...
              Verified Wholesaler Supply Network
           </p>
        </div>
        <div className="flex items-center gap-4">
           <div className="relative group">
              ...
              <input 
                type="text" 
                placeholder="Search Verified Factories..." 
            ...
            <div key={factory.name} className="bg-white rounded-[3.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500 group overflow-hidden flex flex-col cursor-pointer">
               ...
               <div className="p-10 space-y-8 flex-1">
                  <div className="grid grid-cols-2 gap-4">
                     ...
                     <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Factory Capacity</p>
                        <p className="text-xs font-black text-slate-900">{factory.nodes} Active Lines</p>
                     </div>
                  </div>
                  ...
                  <button className="w-full py-5 bg-slate-900 text-white font-black rounded-[2rem] hover:bg-indigo-600 transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-3 active:scale-95 cursor-pointer uppercase tracking-widest text-[10px]">
                     Initiate Wholesale RFQ <ArrowRight className="w-4 h-4 cursor-pointer" />
                  </button>
               </div>
            </div>
         ))}
