...
export default function WholesalerMessagesPage() {
  ...
  const [selectedChat, setSelectedChat] = useState("SinoPrecision");
  ...
  const chats = [
    { id: "SinoPrecision", name: "SinoPrecision Ltd.", lastMsg: "Bulk manifest for WS-1102 is verified.", time: "4m", unread: 3, avatar: "S", status: "online" },
    { id: "MotorWave", name: "MotorWave Dynamic Hub", lastMsg: "Container loading initiated at Port 4.", time: "1h", unread: 0, avatar: "M", status: "online" },
    { id: "VisionCore", name: "VisionCore Systems", lastMsg: "Please review the bulk proforma invoice.", time: "5h", unread: 0, avatar: "V", status: "offline" },
  ];

  const mails = [
    {
      id: "1",
      sender: "SinoPrecision Ltd.",
      subject: "WS-1102: Bulk Sourcing Manifest & Logistics Schedule",
      preview: "Following your container request, we have finalized the sourcing manifest...",
      content: "Dear Wholesale Partner,\n\nWe have finalized the Bulk Sourcing Manifest for Order WS-1102. \n\nTotal Volume: 5,000 Units (High-Performance GPU)\nContainer ID: CN-99021-X\nFOB Port: Shenzhen Yantian\nLogistics Partner: Maersk Global\n\nPlease find the attached Bill of Lading and Proforma Invoice for your records. The first escrow milestone (30%) is now eligible for release.",
      timestamp: "09:15 AM",
      category: "quote",
      read: false,
      starred: true,
    ...
    <div className="h-[calc(100vh-120px)] p-8 space-y-6 animate-in fade-in duration-1000">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
           ...
           <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">Trade Communications</h1>
              <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-0.5 flex items-center gap-2">
                 <Globe className="w-3.5 h-3.5" />
                 Global Wholesale Node: WH-9920
              </p>
           </div>
        </div>
                  ...
                  <div className="flex items-center gap-5">
                     ...
                     <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                           ...
                           <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Encrypted Wholesale Node</p>
                        </div>
                     </div>
                  </div>
                               ...
                               <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-6">
                                     ...
                                     <div>
                                        ...
                                        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">via Leedwey Wholesale Protocol</p>
                                     </div>
                                  </div>
           ...
           <div className="w-full max-w-3xl bg-white rounded-[4rem] shadow-2xl shadow-slate-900/40 overflow-hidden flex flex-col animate-in zoom-in-95 duration-300 border border-slate-100">
              ...
              <div className="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                 <div>
                    ...
                    <p className="text-xs text-slate-400 font-black uppercase tracking-widest mt-1 flex items-center gap-2">
                       ...
                       Encrypted Wholesale Node Protocol
                    </p>
                 </div>
                 <button 
              ...
              <div className="p-10 space-y-8 overflow-y-auto flex-1">
                 ...
                 <div className="p-10 rounded-[3rem] border-4 border-dashed border-slate-50 flex flex-col items-center justify-center text-center group hover:border-indigo-200 transition-all cursor-pointer bg-slate-50/30">
                    ...
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Attach Wholesale Trade Documents</p>
                    <p className="text-[8px] text-slate-300 font-black mt-1">PDF, BULK_INV, SHIP_MANIFEST (MAX 50MB)</p>
                 </div>
              </div>
